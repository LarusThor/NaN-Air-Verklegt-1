...
class UpcomingVoyageIO:
    ...
    def add_upcoming_voyage(self, upcoming_flights: list[UpcomingVoyage]):
        file_path = Path('files/upcoming_flights.csv')

        fieldnames = ['id','flight_nr', 'dep_from', 'arr_at', 'departure', 'arrival', 'captain','copilot','fsm','fa1','fa2','fa3','fa4','fa5']
        ...
        with open(file_path, 'a', newline='', encoding="utf-8") as csvfile:
            ...
            for upcoming_flight in upcoming_flights:
                writer.writerow({'id': upcoming_flight.id, 'flight_nr': upcoming_flight.flight_nr, 'dep_from': upcoming_flight.dep_from, 'arr_at': upcoming_flight.arr_at, 'departure': upcoming_flight.departure, 'arrival': upcoming_flight.arrival, 
