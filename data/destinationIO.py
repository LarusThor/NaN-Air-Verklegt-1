...
class DestinationIO:
    ...
    def read_all_destinations(self) -> list:
        dest_list = []
        with open(
            "files/destinations.csv", "r", newline="", encoding="utf-8"
        ) as csvfile:
    ...
    def add_destination(self, destination: Destination) -> None:
        ...
        with open(
            "files/destinations.csv", "a", newline="", encoding="utf-8"
        ) as csvfile:
            fieldnames = [
                "id",
                "destination",
    ...
    def update_destination(self, updated_destination: Destination) -> None:
        ...
        with open(
            "files/destinations.csv", "w+", newline="", encoding="utf-8"
        ) as csvfile:
            fieldnames = [
                "id",
                "destination",
