...
class VoyagesUI:
    ...
    def add_voyage(self) -> None:
        ...
        #calculates flight number for return flight by adding 1 to the number
        new_flight_number = int(flight_number[-2:]) + 1
        ...
        print("Would you like to save this new voyage: ") 
        print("~" * 20)
